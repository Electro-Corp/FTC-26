...
public final class PinpointLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = 88.9; // y position of the parallel encoder (in tick units)
        public double perpXTicks = 50.8; // x position of the perpendicular encoder (in tick units)
    }
